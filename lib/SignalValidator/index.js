...
SignalValidator.prototype.valid = function(){
	...
	if( typeof this.opts.frequency === 'string' ) {
		var frequency_function_exists = typeof this[ 'valid_' + this.opts.frequency ] === 'function';
		check( 'invalid_frequency'			, frequency_function_exists);

		if( frequency_function_exists ) {
			this[ 'valid_' + this.opts.frequency ]( check );
		}
